 ...
 * be dropped. Visual feedback is provided to the user as the objects are
 * dragged over the views where something can be dropped.
 * 
 * <p>
 * This example starts dragging when a DragSource view is touched. If you want
 * to start with a long press (long click), set the variable
 * mLongClickStartsDrag to true.
 * 
 */
 ...
 */
	...
	private DragController mDragController; // Object that handles a drag-drop
											// sequence.
											// It interacts with DragSource and
											// DropTarget objects.
 ...
 */
	...
	/**
	 * Handle a long click. If mLongClickStartsDrag only is true, this will be
	 * the only way to start a drag operation.
	 * 
	 * @param v
	 *            View
 ...
 */
	...
	/**
	 * React to the start of a drag-drop operation. In this activity, we vibrate
	...
	/**
	 * This method is called on the completion of a drag operation. If the drop
	 * was not successful, the target is null.
	 * 
	 * @param target
	 *            DropTarget
	 * @param success
